...
hist(x = as.numeric(df$Global_active_power), main = paste("Global Active Power"), xlab = "Global Active Power (kilowatts)", col = "red")
dev.print(png, 'plot1.png', width = 843, height = 637)
dev.off()
